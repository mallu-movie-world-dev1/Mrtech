...
FILE_FORWARD = environ.get('FILE_FORWARD',"-1002204207413")
MSG_ALRT = environ.get('MSG_ALRT', '𝑪𝑯𝑬𝑪𝑲 𝑴𝒀 𝑭𝑬𝑨𝑻𝑼𝑹𝑬𝑺')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', '-1002204207413'))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002064884494'))
